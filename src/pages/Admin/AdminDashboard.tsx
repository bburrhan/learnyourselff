          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors w-full text-left"
              >
                <div className="flex items-center">
                  <Bug className="h-8 w-8 text-gray-600 mr-3" />
                  <div>
                    <h3 className="font-semibold text-gray-900">View Application Logs</h3>
                    <p className="text-sm text-gray-700">Debug and monitor application logs</p>
                  </div>
                </div>
