          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <div className="text-center">
              ...
              <div className="space-y-3">
                <LanguageAwareLink
                  to="/login"
                  className="w-full flex justify-center py-2 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white bg-royal-blue-600 hover:bg-royal-blue-700"
                >
                  Back to Login
                </LanguageAwareLink>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  type="email"
                  autoComplete="email"
                  className="appearance-none block w-full px-3 py-2 pl-10 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-royal-blue-500 focus:border-royal-blue-500 sm:text-sm"
